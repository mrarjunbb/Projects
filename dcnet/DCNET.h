...
private:
    ...
    void SendFinalAnnoucementForRing(Ptr<Packet>,int);
    void CalculateFinalAnnouncement();
    void SendAnnoucementForStar(Ptr<Packet>, int );
    void BroadcastAnnouncementsForStar();
